var DWDogecoinQuote = (function() {
  ...
  function refreshCache(cb, fallback) {
    var url = "https://apiv2.bitcoinaverage.com/indices/global/ticker/short?crypto=DOGE&fiat=USD";
    if (fallback) {
  ...
  function buildQuoteFromResponse(apiResponse, fallback) {
    if (fallback) {
      ...
      quoteCache = apiResponse.DOGEUSD.last
    }
