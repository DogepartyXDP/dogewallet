...
- else if absent with first subdomain. for instance fr.wallet.dogeparty.net or testnet-fr.wallet.dogeparty.net
...
function altnize(str) {
  return str
    .replace(/DOGE/g, KEY_ASSET.DOGE)
    .replace(/XDP/g, KEY_ASSET.XDP)
    .replace(/Dogecoin/g, KEY_ASSET.Dogecoin)
    .replace(/XDP/g, KEY_ASSET.Dogeparty);
}
