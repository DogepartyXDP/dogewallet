...
//Order expiration
var ORDER_DEFAULT_EXPIRATION = 129600; //num blocks until expiration (~3 months)
var ORDER_MAX_EXPIRATION = 129600; //max expiration for order
...
var DOGEWALLET_CONF_LOCATION = "/dogewallet.conf.json";
...
var MIN_FEE = 20000; // in satoshis (== .0002 DOGE)
var REGULAR_DUST_SIZE = 5430;
var MULTISIG_DUST_SIZE = 7800;
var MIN_BALANCE_FOR_ACTION = 50000; //in satoshis ... == .0005
var ASSET_CREATION_FEE_XDP = 0.5; //in normalized XDP
var SUBASSET_CREATION_FEE_XDP = 0.25; //in normalized XDP
...
var DOGE_ORDER_MIN_AMOUNT = 0.01;
...
var MAINNET_UNSPENDABLE = 'DParty4kWgih7MpTUivMn1icgC5x7fxALP';
var TESTNET_UNSPENDABLE = 'niV5qKrqwsJyhR7SVrPnpuz2TC3aDKTWgU';
var REGTEST_UNSPENDABLE = 'ndogepartyxxxxxxxxxxxxxxxxxxwpsZCH';
var TESTNET_BURN_START = 3260772;
var TESTNET_BURN_END = 3270852;
...
var DISABLED_FEATURES = []; //set in dogewallet.js

// restricted action
var RESTRICTED_AREA = {} // set in dogewallet.js

var RESTRICTED_AREA_MESSAGE = {
  'pages/simplebuy.html': 'buy_xdp_if_legal'
}

var MAX_SUPPORT_CASE_PROBLEM_LEN = 4096;
var QUOTE_ASSETS = []; // initalized with dogeblock is_ready()
...
var BLOCKEXPLORER_URL = USE_TESTNET ? "https://dogeparty.testnet.xchain.io" : "https://dogeparty.xchain.io";
var GOOGLE_ANALYTICS_UAID = null; //will be set in dogewallet.js
var ROLLBAR_ACCESS_TOKEN = null; //will be set in dogewallet.js
...
var DONATION_ADDRESS = USE_TESTNET ? 'niV5qKrqwsJyhR7SVrPnpuz2TC3aDKTWgU' : 'DParty4kWgih7MpTUivMn1icgC5x7fxALP';
