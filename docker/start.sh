...
export DOGEBLOCK_PORT_MAINNET=${DOGEBLOCK_PORT_MAINNET:=4105}
export DOGEBLOCK_PORT_TESTNET=${DOGEBLOCK_PORT_TESTNET:=14105}
export DOGEBLOCK_PORT_MAINNET_FEED=${DOGEBLOCK_PORT_MAINNET_FEED:=4106}
export DOGEBLOCK_PORT_TESTNET_FEED=${DOGEBLOCK_PORT_TESTNET_FEED:=14106}
export DOGEBLOCK_PORT_MAINNET_CHAT=${DOGEBLOCK_PORT_MAINNET_CHAT:=4107}
export DOGEBLOCK_PORT_TESTNET_CHAT=${DOGEBLOCK_PORT_TESTNET_CHAT:=14107}
